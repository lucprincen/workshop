<?php
/**
 * Plugin Name: Special temporary plugin for CSS Workshop
...
if (!class_exists('PluginIgniter')) {
    ...
    class PluginIgniter {
        ...
        private function load(){
            ...
            load_plugin_textdomain( 'Workshop', false, $path );

            //require the autoloader:
            require( __DIR__ . DS . 'autoloader.php');

            //initiate the autoloader:
            ( new \Workshop\Autoloader() )->register()->load();

            //give off the loaded hook
            do_action( 'Workshop_loaded' );
...
add_action('cuisine_loaded', function(){
	...
	\Workshop\PluginIgniter::getInstance();
